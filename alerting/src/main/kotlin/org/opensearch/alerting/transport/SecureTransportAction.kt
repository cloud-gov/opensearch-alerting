...
interface SecureTransportAction {
    ...
    /**
     * If FilterBy is enabled, this function verifies that the requester user has FilterBy
     * permissions to access the resource. If FilterBy is disabled, we will assume the user has
     * permissions and return true.
     *
